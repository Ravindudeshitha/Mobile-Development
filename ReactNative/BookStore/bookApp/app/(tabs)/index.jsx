...
export default function Home() {
  ...
  const fetchBooks = async (pageNum =1, refresh=false) =>{
    try{
      ...
      const response = await fetch(`${API_URI}books?page=${pageNum}&limit=3`,{
        headers: {
  ...
  const renderItem = ({item}) =>(
    <View style={styles.bookCard}>
      ...
      <View style={styles.bookImageContainer}>
        <Image source={{uri: item.image}} style={styles.bookImage} contectFit="fill" />
      </View>
      ...
      <FlatList 
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>Share your favorite reads</Text>
          </View>
        }
      />
    </View>
